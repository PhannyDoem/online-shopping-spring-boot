...
public class HomeController {
    ...
    public HomeController(CategoryService categoryService, ProductService productService, UserService userService, CommonUtil commonUtil) {
    ...
    public String index(Model m) {
        ...
        List<Category> allActiveCategory = categoryService.getActiveCategory().stream()
